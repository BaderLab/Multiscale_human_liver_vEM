import sys
sys.path.append("/home/codee/scratch/nnUNet")
import argparse
import os.path
...
def find_best_configuration(dataset_name_or_id,
    ...
    # this loop is to essemble all the folds of each m in 'allowed_trained_models'
    # to be combined in one fold. 
    for m in allowed_trained_models:
        ...
        #print(all_results)
    # This one is to essemble two models (like unet and resnet... or 3d full and 3d cascade...)
    if allow_ensembling:
...
def find_best_configuration_entry_point():
    ...
    # This specifies that the argument is a flag. 
    # If the flag is provided in the command line, 
    # args.disable_ensembling will be True; otherwise, it will be False
    ...
    #print(model_dict) # ({'plans': 'nnUNetResEncUNetMPlans', 'configuration': '2d', 'trainer': 'nnUNetTrainer'},)
