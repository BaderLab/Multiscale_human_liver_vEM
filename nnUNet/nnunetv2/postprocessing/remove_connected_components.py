...
def determine_postprocessing(folder_predictions: str,
    ...
    """
    folder_prediction is model (independent or essembled with two independent models) name/identifier.
    ...
    with multiprocessing.get_context("spawn").Pool(num_processes) as pool:
        ...
        # apply the list of arguments to load_postprocess_save function. 
        pool.starmap(
