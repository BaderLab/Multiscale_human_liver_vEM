...
def plan_and_preprocess_entry():
    ...
    parser.add_argument('--verbose', required=False, action='store_true',
                        help='Set this to print a lot of stuff. Useful for debugging. Will disable progress bar! '
                             'Recommended for cluster environments')
    parser.add_argument('--fingerprint', required=False, default=False, action="store_true", 
                        help='Set this to extract the fingerprint without planning and preprocessing')
    parser.add_argument('--planning', required=False, default=False, action="store_true", 
                        help='Set this to only planning')
    parser.add_argument('--preprocessing', required=False, default=False, action="store_true", 
                        help='Set this to only preprocessing')
    parser.add_argument('-plans_name', default='nnUNetPlans', required=False,
                        help='[OPTIONAL] You can use this to specify a custom plans file that you may have generated')
    args = parser.parse_args()
    
    if args.planning == False and args.preprocessing == False:
