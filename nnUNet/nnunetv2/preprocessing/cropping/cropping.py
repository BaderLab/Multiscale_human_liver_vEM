...
def crop_to_nonzero(data, seg=None, nonzero_label=-1):
    """
    crop an input array (data) to the bounding box of its non-zero elements. 
    focus only on the regions containing meaningful data (non-zero regions) 
    and ignore the background or zero-value regions.
    :param data:
    :param seg:
