...
class nnUNetTrainer(object):
    ...
    def configure_rotation_dummyDA_mirroring_and_inital_patch_size(self):
        ...
        initial_patch_size = get_patch_size(patch_size[-dim:],
                                            ...
                                            rotation_for_DA,
                                            (0.85, 1.25))
        #print("kkkkkkkkkk:", initial_patch_size) # ex. (1505, 1505)
        if do_dummy_2d_data_aug:
    ...
    def get_tr_and_val_datasets(self):
        ...
        dataset_tr = nnUNetDataset(self.preprocessed_dataset_folder, tr_keys,
                                   folder_with_segs_from_previous_stage=self.folder_with_segs_from_previous_stage,
                                   num_images_properties_loading_threshold=0)
        #print("train_keys:", tr_keys)
        #print(len(dataset_tr))
        dataset_val = nnUNetDataset(self.preprocessed_dataset_folder, val_keys,
                                    folder_with_segs_from_previous_stage=self.folder_with_segs_from_previous_stage,
                                    num_images_properties_loading_threshold=0)
        #print("validation_keys:", val_keys)
    ...
    def train_step(self, batch: dict) -> dict:
        data = batch['data']
        target = batch['target']
        #print("datashape:", data.shape) # [batch, channel, x, y] ex. [2,1,1280,1024]
    ...
    def on_epoch_end(self):
        ...
        if (current_epoch + 1) % self.save_every == 0 and current_epoch != (self.num_epochs - 1):
            self.save_checkpoint(join(self.output_folder, f'checkpoint_latest{current_epoch}.pth'))
    ...
    def run_training(self):
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            train_outputs = []
            #print(range(self.num_iterations_per_epoch)) #(1, 250) a constant defined in _init_
